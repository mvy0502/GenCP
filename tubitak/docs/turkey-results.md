...
controlled (gate passed at +0.012 px — **figure PENDING re-run**, corrections-log entry 15: the gate corpus was later found two-thirds stale); the imagery side is not. The claim is therefore:
